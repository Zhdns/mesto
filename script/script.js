const popUpOpenButton = document.querySelector('.profile__account__info__button');
const popUpCloseButton = document.querySelector('.container__clouse-button');
const popUp = document.querySelector('.pop-up');
const profileName = document.querySelector('.profile__account__info__name');
const profilePofession = document.querySelector('.profile__account__info__profession');
